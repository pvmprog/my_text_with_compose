...
@Composable
fun  ArrowNewIndicatorPreview() {
    MyTextWithComposeTheme {
        ArrowNewIndicator(false)
    }
}
...
@Composable
fun  ArrowNewIndicatorPreviewExpanded() {
    MyTextWithComposeTheme {
        ArrowNewIndicator(true)
    }
}
